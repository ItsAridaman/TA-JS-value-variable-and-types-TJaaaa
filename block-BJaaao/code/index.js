...
alert(`the sum of both the numbers is: ${Number(numA) + Number(numB)}`)
alert(`the difference of both the numbers is: ${numA - numB}`)
alert(`the multiplication for both the numbers is: ${numA * numB}`)
